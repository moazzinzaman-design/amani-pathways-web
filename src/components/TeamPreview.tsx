...
const teamMembers = [
    {
        ...
        bio: "Sarah brings over 15 years of experience in residential care, specialising in trauma-informed practice and safeguarding for UASC. She leads the team with compassion and a commitment to high standards.",
        image: "/images/halifax-market.png", // Placeholder
        credentials: ["Level 5 Diploma in Leadership & Management", "Designated Safeguarding Lead"],
        email: "manager@amanipathways.co.uk",
    },
    {
        name: "David Osei",
        role: "Deputy Manager",
        bio: "David's background is in youth work and community integration. He excels at building rapport with young people and creating engaging, culturally sensitive life skills programs.",
        image: "/images/education-halifax.png", // Placeholder
        credentials: ["Level 3 Diploma in Residential Childcare", "Mental Health First Aider"],
        email: "deputy@amanipathways.co.uk",
    },
    {
        name: "Amira Patel",
        role: "Senior Support Worker",
        bio: "Fluent in Arabic and Pashto, Amira is instrumental in helping newly arrived young people feel understood and safe. She leads our educational advocacy efforts.",
        image: "/images/halifax-park.png", // Placeholder
        credentials: ["Level 3 Diploma in Supported Accommodation", "Bilingual Support Specialist"],
        email: "support@amanipathways.co.uk",
    }
];
